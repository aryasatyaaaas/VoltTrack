...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'UserPreferences_userId_key'
    ) THEN
        ALTER TABLE "UserPreferences" ADD CONSTRAINT "UserPreferences_userId_key" UNIQUE ("userId");
    END IF;
END $$;
